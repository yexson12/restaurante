...
<div class="quick-sidebar">
            ...
            <div class="tab-chat tab-pane fade show active" id="messages" role="tabpanel">
                        ...
                        <div class="quick-scroll scrollbar-outer">
                            <div class="quick-content contact-content">
                                ...
                                <div class="contact-list">
                                    <div class="user row-sm-6 row-lg-3 mr-2">
                                        <div class="card  mb-2">
                                            <a href="#" class="d-flex flex-column">
                                                <div class="user-data d-flex flex-row justify-content-between align-items-center col-12 m-0 mb-2 pb-1 pl-1 pr-1"
                                                    ...
                                                    <span class="name text-muted text-center m-0">Plato</span>
                                                    <button class="cerrar-orden col-1 p-0 btn btn-light"><i
                                                                class="cerrar-orden fa fa-trash text-danger m-0 p-0 text-center"></i></button>
                                                </div>
                                                <div class="d-flex align-items-center go-details">
                                                    <div class="col-12">
                                                        <small class="name h5"><b>PARRILLA BABY CHICKEN aaaaaaaa
                                                                aaaaa xd</b></small>
                                                        <div class="mb-1 mt-2 d-flex flex-column">
                                                            <div class="d-flex align-items-center">
                                                                        <span class="text-muted">Cantidad: &nbsp;
                                                                            <b>4</b></span>
                                                                <span class="badge badge-black"><b>S/.
                                                                                40,00</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="messages-wrapper">
                    <div class="messages-title d-flex flex-reverse align-items-center">
                        ...
                        <div class="user">
                            <span class="h2">PARRILLA BABY CHICKEN</span>
                        </div>
                    </div>
                    <div class="">
                        <div class="row-md-4">
                            <div class="card card-post card-round">
                                <img class="card-img-top" src="../assets/img/proyecto/chadengle.jpg"
                                     alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">1/2 Pollo Bebé, Papi Julio EXTREMO, Churrasco
                                        Anticuchero, 02 Chuletas de Cerdo y 02 Chorizos., papas fritas y
                                        Ensalada.</p>

                                    <div class="d-flex justid-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center form-group pl-0">
                                            <button class="button-spinner" id="decrement"
                                                    onclick="stepper(this,'spn-quick-sidebar')"> - </button>
                                            <input class="input-spinner" disabled type="number" min="1"
                                                   max="100" step="1" value="1" id="spn-quick-sidebar" readonly>
                                            <button class="button-spinner" id="increment"
                                                    onclick="stepper(this,'spn-quick-sidebar')"> + </button>
                                        </div>
                                        <span class="h3 m-0"><b>S/. 129.90</b></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-12 pr-5 pb-3 d-flex" style="position: absolute; bottom: 0; height: 70px;">
        <div class="col-12 p-0 d-flex justify-content-between align-items-center">
            ...
            <b class="h2 m-0 mr-3">S/. 420,00</b>
        </div>
    </div>
</div>
