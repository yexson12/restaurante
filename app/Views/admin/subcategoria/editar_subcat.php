                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Actualizar subcategoria</p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input required v-model="NOMBRE_SUBCAT" value="<?= $subcategoria['NOMBRE_SUBCAT']; ?>"  class="form-control" name="NOMBRE_SUBCAT" type="text" placeholder="Nombre la categoria" :class="{ 'is-invalid': errors.barcode }" n>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label required for="exampleFormControlTextarea1">ID CATEGORIA</label>
                                        <input required v-model="ID_CATEGORIA" value="<?= $subcategoria['ID_CATEGORIA']; ?>"  class="form-control" name="ID_CATEGORIA" type="text" placeholder="Nombre la subcategoria" :class="{ 'is-invalid': errors.barcode }" n>
