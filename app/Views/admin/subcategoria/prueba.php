                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input required v-model="PRODUCTO_NOMBRE" class="form-control" value="<?= $subcategoria['ID_SUBCAT']; ?>" name="NOMBRE_SUBCAT" type="text" placeholder="Nombre de subcategoria" :class="{ 'is-invalid': errors.barcode }" n>
                                        <div class="invalid-feedback">{{ errors.barcode }}</div>
                                    </div>
                                </div>
                                <?php if ($subcategoria['ID_SUBCAT']== 0 ): ?>
                                    <div class="col-md-2">
