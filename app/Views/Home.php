...
<body>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img">
													<img src="<?= base_url() ?>/public/atlantis/assets/img/jm_denis.jpg" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img">
													<img src="<?= base_url() ?>/public/atlantis/assets/img/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img">
													<img src="<?= base_url() ?>/public/atlantis/assets/img/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img">
													<img src="<?= base_url() ?>/public/atlantis/assets/img/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img">
													<img src="<?= base_url() ?>/public/atlantis/assets/img/profile2.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="<?= base_url() ?>/public/atlantis/assets/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?= base_url() ?>/public/atlantis/assets/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
						...
						<li class="nav-item active">
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									<li>
										<a href="<?= base_url() ?>/public/atlantis/demo1/index.html">
											<span class="sub-item">Dashboard 1</span>
										</a>
									</li>
									<li>
										<a href="<?= base_url() ?>/public/atlantis/demo2/index.html">
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url() ?>/public/atlantis/assets/img/flags/id.png" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url() ?>/public/atlantis/assets/img/flags/us.png" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url() ?>/public/atlantis/assets/img/flags/au.png" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url() ?>/public/atlantis/assets/img/flags/ru.png" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url() ?>/public/atlantis/assets/img/flags/cn.png" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url() ?>/public/atlantis/assets/img/flags/br.png" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="<?= base_url() ?>/public/atlantis/assets/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="<?= base_url() ?>/public/atlantis/assets/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
	...
	<script src="<?= base_url() ?>/public/atlantis/assets/js/setting-demo.js"></script>
	<script src="<?= base_url() ?>/public/atlantis/assets/js/demo.js"></script>
	<script>
		Circles.create({
			id:'circles-1',
			radius:45,
